  ...
  return (
    <div className="via-primary-800 from-primary-900 to-slate-950 bg-gradient-to-br text-white min-h-screen py-16 px-4">
      <div className="container mx-auto max-w-5xl space-y-12">
        ...
        {/* Our Story */}
        <section>
          <h2 className="text-2xl font-semibold mb-4">{t("about_story_heading")}</h2>
        ...
        {/* Our Mission */}
        <section>
          <h2 className="text-2xl font-semibold mb-4">{t("about_mission_heading")}</h2>
          <p className="text-gray-300">
        ...
        {/* Our Vision */}
        <section>
          <h2 className="text-2xl font-semibold mb-4">{t("about_vision_heading")}</h2>
          <p className="text-gray-300">
            {t("about_vision_paragraph")}
          </p>
        </section>

        {/* Why Choose Us? / Our Values */}
        <section>
          <h2 className="text-2xl font-semibold mb-4">{t("about_why_choose_heading")}</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">{t("about_team_heading")}</h2>
          <p className="text-gray-300">
            {t("about_team_paragraph")}
          </p>
        </section>
      </div>
    </div>
